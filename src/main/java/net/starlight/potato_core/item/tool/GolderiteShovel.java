...
public class GolderiteShovel extends ShovelItem implements GolderiteToolEnchantItem {
    public GolderiteShovel(float attackDamage, float attackSpeed, Settings settings) {
