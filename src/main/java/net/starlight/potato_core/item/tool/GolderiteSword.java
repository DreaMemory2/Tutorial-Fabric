...
public class GolderiteSword extends SwordItem implements GolderiteToolEnchantItem {
    public GolderiteSword(int attackDamage, float attackSpeed, Settings settings) {
