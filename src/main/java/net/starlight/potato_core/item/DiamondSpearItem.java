...
public class DiamondSpearItem extends Item implements Vanishable {
    ...
    public void onStoppedUsing(ItemStack stack, World world, LivingEntity user, int remainingUseTicks) {
        ...
        if (!world.isClient) {
            ...
            if (j == 0 ) {
                DiamondSpearEntity tridentEntity = new DiamondSpearEntity(world, playerEntity, stack);
                if (playerEntity.getAbilities().creativeMode) tridentEntity.pickupType = PersistentProjectileEntity.PickupPermission.CREATIVE_ONLY;
