...
public class DrinkMachineScreenHandler extends ScreenHandler {
     ...
     */
    public DrinkMachineScreenHandler(int syncId, PlayerInventory playerInventory) {
     ...
     * @param syncId 窗口界面的Id
     * @param playerInventory 玩家的库存
     * @param inventory 方块库存
     * @param propertyDelegate 进度信息
     */
    public DrinkMachineScreenHandler(int syncId, PlayerInventory playerInventory, Inventory inventory, PropertyDelegate propertyDelegate) {
        ...
        // 设置插槽，与GUI的插槽位置对应
        // 输入插槽
        this.addSlot(new Slot(inventory, 0, 37, 31));
        // 输出插槽
        this.addSlot(new Slot(inventory, 1, 85, 31));
        // 加热插槽
        this.addSlot(new Slot(inventory, 2, 118, 20));
        // 冷却插槽
        this.addSlot(new Slot(inventory, 3, 118, 52));
        // 液体插槽
